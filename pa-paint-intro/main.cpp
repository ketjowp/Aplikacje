...
void onPaint(HWND hwnd, WPARAM wp, LPARAM lp)
{
	...
	MoveToEx(ps.hdc,((r.left+r.right)/2),r.top+20,NULL);
	LineTo(ps.hdc,((r.left+r.right)/2),r.bottom-20);
	MoveToEx(ps.hdc,r.left+20,((r.top+r.bottom)/2),NULL);
	LineTo(ps.hdc,r.right-20,((r.top+r.bottom)/2));
